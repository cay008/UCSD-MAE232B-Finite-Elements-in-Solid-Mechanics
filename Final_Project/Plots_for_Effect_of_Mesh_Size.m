...
%     xlim([4.9, 5])
%     for i = 1 : 4
%         x = linspace(R_i,R_o,nof_element_all(i)+1);
%         index = find(x==location(loc));
%         plot(t, sol_disp{1,i}(index,:), plot_string{i},'LineWidth',2);
%     end
%     legend('10 Element','20 Element','40 Element','80 Element','Location','northwest')
% end
% 
% % Plots for central difference
% for loc = 1 : 3
...
for loc = 1 : 3
    ...
    legend('10 Element','20 Element','40 Element','80 Element','Location','southwest')
end
...
for loc = 1 : 3
    ...
    for i = 1 : 4
        x = linspace(R_i,R_o,nof_element_all(i)+1);
        index = find(x==location(loc));
        plot(t, sol_sigma_rr{2,i}(3,:),plot_string{i},'LineWidth',2);
    end
    legend('10 Element','20 Element','40 Element','80 Element','Location','southwest')
end